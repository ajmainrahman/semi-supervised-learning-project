...
* Image tagging (multiple objects)
* Medical imaging with multiple findings
* Music genre tagging
* News article topic assignment
...
* Stock price prediction (point estimate)
* Water quality parameter estimation (pH, TOC, turbidity 👀)
...
* Hospital patient inflow prediction

---

### 2.3 Survival / Risk Regression

* Patient survival time estimation
...
* Handwritten word recognition (Bangla 👀)
...
Each sub-project includes its own dataset, methodology, experiments, and analysis.
